...
public class PenomiorItemDataSerializer {
    ...
    private @NotNull PenomiorItemDataMap getDefaultData() {
        ...
        // Unique
        defaultData.put("minecraft:trident", new PenomiorItemData("minecraft:trident", 20, 0, 182, 0, 0, 100, 0, 20, 0, 0, 1));
        ...
        //Bow
        defaultData.put("minecraft:bow", new PenomiorItemData("minecraft:bow", 20, 0, 182, 0, 0, 100, 0, 0, 0, 0, 5));
        defaultData.put("minecraft:crossbow", new PenomiorItemData("minecraft:crossbow", 20, 0, 182, 0, 0, 100, 0, 0, 0, 0, 5));
