...
public class ModEntityAttributes {
    public static final RegistryEntry<EntityAttribute> GENERIC_CRIT_DAMAGE = register("generic.crit_damage", new ClampedEntityAttribute("attribute.name.generic.crit_damage", 0.5, 0.0, 64.0).setTracked(true));
    ...
    public static final RegistryEntry<EntityAttribute> GENERIC_MAGIC_ATTACK_DAMAGE = register("generic.magic_attack_damage", new ClampedEntityAttribute("attribute.name.generic.magic_attack_damage", 0, 0.0, 4.0).setTracked(true));
    public static final RegistryEntry<EntityAttribute> GENERIC_MELEE_ATTACK_DAMAGE = register("generic.melee_attack_damage", new ClampedEntityAttribute("attribute.name.generic.melee_attack_damage", 0, 0.0, 4.0).setTracked(true));
    public static final RegistryEntry<EntityAttribute> GENERIC_PROJECTILE_ATTACK_DAMAGE = register("generic.projectile_attack_damage", new ClampedEntityAttribute("attribute.name.generic.projectile_attack_damage", 0, 0.0, 4.0).setTracked(true));
